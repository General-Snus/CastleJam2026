...
public class UIInputCassetMenu : MonoBehaviour
{
    ...
    public void UpdateUI(PlayerController controller, TripodController tripodController)
    {
        ...
        var type1 = tripodController.cassets[0] == null ? Projectable.Type.none : tripodController.cassets[0].type;
        ...
        var type2 = tripodController.cassets[1] == null ? Projectable.Type.none : tripodController.cassets[1].type;
        ...
        var type3 = tripodController.cassets[2] == null ? Projectable.Type.none : tripodController.cassets[2].type;
